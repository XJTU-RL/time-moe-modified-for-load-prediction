...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', '-d', type=str, help='Path to trainingMaple728/TimeMoE-200M data. (Folder contains data files, or data file)')
    parser.add_argument('--model_path', '-m', type=str, default='Maple728/TimeMoE-200M', help='Path to pretrained model. Default: Maple728/TimeMoE-200M')
    parser.add_argument('--output_path', '-o', type=str, default='logs/5y/fp16_1e-5cos_1024')
    ...
    parser.add_argument('--attn_implementation', type=str, choices=['eager', 'flash_attention_2'], default='flash_attention_2', help='attention implementation')
    ...
    parser.add_argument('--global_batch_size', type=int, default=48, help='global batch size')
    parser.add_argument('--micro_batch_size', type=int, default=48, help='micro batch size per gpu')
    
    parser.add_argument('--precision', choices=['fp32', 'fp16', 'bf16'], type=str, default='fp16', help='precision mode (default: fp32)')
    ...
    parser.add_argument('--save_strategy', choices=['steps', 'epoch', 'no'], type=str, default='epoch', help='save strategy')
